...
All file paths are defined relative to the project root. Raw data files are stored on Google Drive:
https://drive.google.com/drive/folders/1qhlCgEDZf6_V5UZm3bGnyvRdhsjHgEl5

Download the data folder and place its contents inside `data/` before running this script.
